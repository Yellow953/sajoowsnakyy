...
<div class="container mt-5">
    <div class="card">
        <form action="{{ route('reports.update', $report->id) }}" method="POST" enctype="multipart/form-data"
            ...
            @csrf
            <div class="card-head">
                <h1 class="text-center text-primary">Edit Report</h1>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="currency_id" class="form-select" data-control="select2" required
                                ...
                                <option value="{{ $currency->id }}" {{ $report->currency_id==$currency->id ? 'selected'
                                    :
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" class="form-control" name="start_cash"
                                placeholder="Enter Start Cash..." value="{{ $report->start_cash }}" required />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" class="form-control" name="end_cash"
                                placeholder="Enter End Cash..." value="{{ $report->end_cash }}" required />
                        </div>
                    </div>
                </div>
            </div>
